...
public class UserServiceImpl implements UserService {
    ...
    public int editPassword(User user) {
        ...
        //        String oldPassword = new Md5Hash(user.getOldPassword(), ((User)
        // (SecurityUtils.getSubject().getSession()
        //                .getAttribute("user"))).getAccount(), 1024).toString();
        //        if (!oldPassword.equals(password)) {
        //            return 0;
        //        }
        //        Md5Hash md5Hash = new Md5Hash(user.getPassword(), ((User)
        // (SecurityUtils.getSubject().getSession().getAttribute("user"))).getAccount(), 1024);
